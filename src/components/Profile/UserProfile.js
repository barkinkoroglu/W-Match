        ...
        <div className='p-2 bg-white rounded-lg flex flex-col gap-y-2  relative group '>
          ...
          >
            <span className='text-gray-700'>
              {`${user.name} ${user.lastname}'s CV  `}
            </span>
            <span className='inline-block bg-blue-500 hover:bg-blue-700 text-white  py-1 px-2 rounded-lg text-lg ml-2'>
              Download CV
            </span>
          </a>
          ...
          {ruser.username === param.id && (
            <button
              ...
              className='absolute hidden group-hover:inline text-gray-400 top-3 right-2 z-50 hover:text-gray-600 duration-300 transition-colors'
            >
              <SettingsIcon />
            </button>
          )}

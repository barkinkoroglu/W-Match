  ...
  return (
    <div className=" ">
      <div className="flex flex-col  max-w-6xl px-3 mx-auto   ">
        ...
        <div className=" flex flex-col sm:flex-row  py-5 mx-auto justify-between h-[calc(100vh-64px)] gap-x-4 ">
        ...
        <div className=" flex flex-col sm:flex-row  py-5 mx-auto justify-between h-screen gap-x-4 ">
          <div className="flex flex-1 text-5xl sm:text-5xl lg:text-7xl items-center">
            <h1>Millions of jobs and people hiring </h1>
          </div>
          <div className="flex flex-1  ">
